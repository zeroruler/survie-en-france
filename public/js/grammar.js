...
const saveGrLocal = (d) => localStorage.setItem(LS_KEY_GR, JSON.stringify(d));
const getScore  = () => { try { return parseInt(localStorage.getItem(LS_SCORE_GR) || "0"); } catch { return 0; } };
const addScore  = (n) => localStorage.setItem(LS_SCORE_GR, String(getScore() + n));
...
function renderGrammarPage() {
  ...
  page.innerHTML = `
    <link rel="stylesheet" href="public/css/grammar.css?v=10" />
