...
function renderVocabPage() {
  ...
  page.innerHTML = `
    <link rel="stylesheet" href="public/css/vocab.css?v=12" />
    ...
    <div id="vocab-today-view">
      ...
      <div class="flashcard-arena" id="flashcard-arena">
        ...
        <div class="swipe-label swipe-no"  id="swipe-no">✕ 모름</div>
        <div class="swipe-label swipe-yes" id="swipe-yes">✓ 알아!</div>
      </div>
...
function renderCard() {
  ...
  document.getElementById("swipe-no").style.opacity  = "0";
  document.getElementById("swipe-yes").style.opacity = "0";
...
function bindVocabEvents() {
  ...
  const noLabel  = document.getElementById("swipe-no");
  const yesLabel = document.getElementById("swipe-yes");
  ...
  arena?.addEventListener("touchmove", (e) => {
    ...
    if (dx > 40)         { noLabel.style.opacity = "0"; yesLabel.style.opacity = Math.min((dx-40)/60,1); }
    else if (dx < -40)   { yesLabel.style.opacity = "0"; noLabel.style.opacity = Math.min((-dx-40)/60,1); }
    else                 { noLabel.style.opacity = "0"; yesLabel.style.opacity = "0"; }
  }, { passive: true });
